...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		listProjects();
		Integer projectId = getIntInput("Please select a project you want to delete: ");
	...
	private void updateProjectDetails() {
		...
		BigDecimal estimatedHours = 
				getDecimalInput("Enter the project Estimated Hours [" + curProject.getEstimatedHours() + "]");		
		BigDecimal actualHours = 
				getDecimalInput("Enter the project Actual Hours [" + curProject.getActualHours() + "]");		
